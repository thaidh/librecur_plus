...
//    private final static CalendarMetrics DEFAULT_CALENDAR_SCALE = new GregorianCalendarMetrics(Weekday.MO, 4);
    private final static CalendarMetrics DEFAULT_CALENDAR_SCALE = new ChineseCalendarMetrics(Weekday.MO, 4);
...
//            rScaleCalendarMetrics = new ChineseCalendarMetrics(getWeekStart(), 4);
